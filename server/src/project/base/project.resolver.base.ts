...
export class ProjectResolverBase {
  ...
  async createProject(
    ...
    return await this.service.create({
      ...
      data: {
        ...
        workflows: args.data.workflows
          ? {
              connect: args.data.workflows,
            }
          : undefined,
      },
    });
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [User], { name: "collaborators" })
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "read",
    possession: "any",
  })
  async resolveFieldCollaborators(
  ...
  async resolveFieldWorkflows(
    ...
    const result = await this.service.getWorkflows(parent.id);
